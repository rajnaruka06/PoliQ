...
const HelpOverlay: React.FC<HelpOverlayProps> = ({ showHelp, closeHelp }) => {
    ...
    return (
        <div className="flex fixed inset-0 z-50 justify-center items-center bg-black bg-opacity-50">
            <div
                className="p-8 w-full max-w-lg text-black bg-white rounded-lg shadow-lg 3xl:max-w-4xl dark:text-white dark:bg-darkSecondary"
                style={{
                    maxHeight: "80vh",
                    display: "flex",
            ...
            >
                ...
                <div className="flex overflow-y-auto flex-col gap-2">
                    ...
                    <li className="">
                        ...
                        ): Click this icon located within the chat bar of the
                        PoliQ Chat to upload a dataset file
                    </li>
                    <li className="">
                        ...
                        ): Click this icon located within the text box of the
                        PoliQ Chat sidebar, and then click{" "}
                    ...
                    <li className="">
                        ...
                        ): The search functionality is located beside this icon
                        in the PoliQ Chat sidebar. Type words corresponding to
                        the chat name to search for the chat of interest.
                    </li>
                    <li className="">
                        <span className="font-semibold">
                        ...
                        ): Click this icon located at the bottom of PoliQ Chat
                        sidebar to expand options to "View All Chats" and
                        "Archived Chats".
                    </li>
                    <li className="">
                        <span className="font-semibold">Dark/Light Mode</span>
                        (<AiFillMoon className="inline-block" /> for dark mode,{" "}
                        <AiFillSun className="inline-block" /> for light mode):
                        Click the corresponding icon located on the top-right
                        corner of the page to swap between dark and light
                        themes.
                    </li>
                    <li className="">
                        <span className="font-semibold">
                        ...
                        ): Click this icon located in the top-right corner of
                        the PoliQ Chat sidebar to minimise the sidebar
                        temporarily.
                    </li>
                    <li className="">
                        <span className="font-semibold">
                        ...
                        ): Click this icon located on the minimised sidebar to
                        re-expand the PoliQ Chat sidebar to full view.
                    </li>
                    <li className="">
                        <span className="font-semibold">
                        ...
                        <ul className="ml-5">
                            <li>
                                ...
                                button to pin a chat (for a pinned chat, click{" "}
