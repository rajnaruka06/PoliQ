...
from .customAgents import SqlExpert, ResponseSummarizer, RouterAgent, ChatAgent, DatasetRegionMatcherAgent, SqlExpert2
import sys
import os
import re
...
class ElecDataWorkflow2:
    ...
    def __init__(self):
        self.dbName = os.getenv("ELECDATA_DB_NAME")
        self.llm = loadLLM()
        self.sqlCoderAgent = SqlExpert2(llm=self.llm)
        self.sqlQueryTool = QuerySQLTool(dbName=self.dbName)
        self.tableInfo = None
        self.dialect = None
        self._setTableInfo()
